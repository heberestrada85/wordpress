...
<?php $classes = array('product', 'col_item', 'type-product', 'hide_sale_price', 'rehub-main-smooth', 'position-relative', 'rh-shadow5', 'flowhidden', 'woodealgrid', 'darkbg', 'woodealgriddark', 'dark_btn_action');?>
...
<?php $sales_html = ''; if ( $product->is_on_sale()) : ?>
    ...
    if ($percentage && $percentage>0 && !$product->is_type( 'variable' )) {
        $sales_html = '<div class="font90"><span>-' . $percentage . '%</span></div>';
        $classes[] = 'prodonsale';
    }
    ?>
<?php endif; ?>
...
<?php 
    $imagefull = get_the_post_thumbnail_url( $post->ID,'mediumgrid' );
    $randomclass = 'darkgrid'.mt_rand();
    $classes[] = $randomclass;
            ...
            <?php if($price_meta != '4'):?>
                <div class="rh-flex-right-align pl15">
                    <?php if($syncitem && $price_meta == '1'):?>
                        ...
                        <?php if($celogo) :?>
                            <div class="border-grey-dashed orangecolor width-80 height-80 rh-flex-center-align rh-flex-justify-center text-center rh-shadow3 pt5 pb5 pl5 pr5 roundbd8im roundborder8">
                                <div>
                    ...
                    <?php elseif($price_meta == '3'):?>
                        <div class="border-grey-dashed roundborder8 darkhalfopacitybg width-80 rh-flex-center-align rh-flex-justify-center text-center rh-shadow3 pt5 pb5 pl5 pr5">      
                            <div class="font120 fontbold">
                                <?php if($sales_html):?>
                                    <?php echo ''.$sales_html; ?>
                                <?php else:?>

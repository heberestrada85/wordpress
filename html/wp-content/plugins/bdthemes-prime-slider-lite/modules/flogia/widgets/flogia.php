...
class Flogia extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control( 'show_thumbnav', [
            'label'     => esc_html__( 'Show Thumbs', 'bdthemes-prime-slider' ) . BDTPS_PC,
            'type'      => Controls_Manager::SWITCHER,
            'default'   => 'yes',
            'separator' => 'before',
        ] );
        ...
        $this->add_responsive_control( 'ps_content_innner_padding', [
        ...
        $this->add_control( 'title_hover_color', [
            'label'     => esc_html__( 'Hover Color', 'bdthemes-prime-slider' ) . BDTPS_NC,
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_responsive_control( 'ps_category_space_between', [
        ...
        $this->add_control( 'category_hover_heading', [
            'label'     => __( 'HOVER', 'bdthemes-prime-slider' ) . BDTPS_NC,
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before',
        ] );
        ...
        $this->add_control( 'meta_text_hover_color', [
            'label'     => __( 'Hover Color', 'bdthemes-prime-slider' ) . BDTPS_NC,
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'author_avatar_heading', [
            'label'     => __( 'AVATAR', 'bdthemes-prime-slider' ) . BDTPS_NC,
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before',
        ] );
        ...
        //normal tab
        $this->start_controls_tab( 'tab_featured_post_normal', [
        ...
        $this->add_responsive_control( 'featured_thumbs_padding', [
            'label'      => esc_html__( 'Title Padding', 'bdthemes-prime-slider' ) . BDTPS_NC,
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', 'em', '%' ],
            'selectors'  => [
        ...
        $this->add_responsive_control( 'featured_thumbs_title_margin', [
            'label'      => esc_html__( 'Title Margin', 'bdthemes-prime-slider' ) . BDTPS_NC,
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', 'em', '%' ],
            'selectors'  => [
        ...
        $this->add_responsive_control( 'featured_thumbs_margin', [
            'label'      => esc_html__( 'Thumbs Margin', 'bdthemes-prime-slider' ) . BDTPS_NC,
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', 'em', '%' ],
            'selectors'  => [
        ...
        $this->end_controls_tab();
        //active tab
        $this->start_controls_tab( 'tab_featured_post_active', [
            'label' => esc_html__( 'Active', 'bdthemes-prime-slider' ) . BDTPS_NC,
        ] );
        $this->add_control( 'featured_post_title_color_active', [
            'label'     => __( 'Color', 'bdthemes-prime-slider' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'featured_post_background_color_active', [
            'label'     => __( 'Background Color', 'bdthemes-prime-slider' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'featured_post_overlay_color_active', [
            'label'     => __( 'Overlay Color', 'bdthemes-prime-slider' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
    ...
    public function render_slides_loop()
    {
        ...
        while ( $wp_query->have_posts() ) {
            ...
            ?>
                        ...
                        <?php 
            $this->rendar_post_image( "bdt-ps-slide-img" );
            ?>
